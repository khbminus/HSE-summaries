...
\end{theorem}
\begin{remark}
    Аналогично $\exists! S_1, U_1 : \mathcal{A} = S_1 \circ U_1$ (порядок другой)
...
\begin{theorem}
    $\CA : U \to V$ --- линейное, $U, V$ --- евклидовы пространства. Тогда $\exists$ ОНБ $e_1, \cdots, e_n$ в $U$, $f_1, \cdots , f_n$ в $V$ такие, что $[\CA] = \begin{pmatrix} G_1 & 0 & \cdots & 0 \\ 0 & G_2 & \cdots & 0 \\ \vdots & & G_k & \vdots \\ 0 & 0 & \cdots & 0  \end{pmatrix}$ и $G_i > 0$. Т.е. $\exists$ ОНБ, переводящий в ортогональный. 
\end{theorem}
\begin{proof}
	...
	$A^T A(e_i) = s_i e_i, s_i \ge 0$, положим $f_i = A(e_i)$. 
\end{proof}
