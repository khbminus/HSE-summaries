...
\begin{definition}
    Пусть $f\!: [a, b] \to \R$, тогда $f$  интегрируема по Риману, если $\exists I \in \R \forall \eps > 0 \forall \delta > 0 \forall$ дробление ранги  $< \delta \forall$ его оснащение  $|S(f, \tau, \xi) - I| < \eps$. 
