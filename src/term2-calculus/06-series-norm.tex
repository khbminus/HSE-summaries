...
\begin{theorem}
    ...
    Если  $\sum\limits_{n=1}^\infty x_n$ абсолютно сходится, то он абсолютно сходится.
\end{theorem}
\begin{proof}
    ...
    $S_n \coloneqq \sum\limits_{k=1}^n x_k$ и  $S_{n_k} \to S$.
     \begin{enumerate}
         \item Возьмем $n$:  $n_k \le n < n_{k+1}$. $S_n = S_{n_k} + x_{n_k} + x_{n_k + 1} + x_{n_k  + 2} + \ldots + x_n$. $\|S_n - S\| \le \|S_{n_k} - S\| + \|x_{n_k + 1}\| + \ldots + \|x_n\|$. Мы знаем, что $S_{n_k} \to S \implies \exists K \forall k \ge K\!: \|S_{n_k} - S\| < \eps$.
             ...
             $\lim x_j = 0 \implies \exists J \forall j \ge J \|x_j\| < \eps$. Следовательно исходная сумма не более $(M+1)S$.
...
\begin{theorem}[Признак сравнения]
    ...
    \begin{enumerate}
        ...
        \item  Если $\sum\limits_{n=1}^\infty a_n$ --- расходится.
    \end{enumerate}
\end{theorem}
\begin{proof}
    \begin{enumerate}
...
\begin{proof}
    \begin{enumerate}
        ...
        \item Если $q^* > 1$. Найдется  $n_k\!: \sqrt[n_k]{a_{n_k}} \to q^*  > 1$ (по определению верхнего предела)  $\implies$ начиная с некоторого номера $\sqrt[n_k]{a_{n_k}} > 1 \implies a_{n_k} > 1 \implies a_n \centernot 0$ и ряд расходится.
...
\begin{proof}
    ...
    Если ряд сходится, то $S_n$ --- ограничена  $\implies \int\limits_1^n f(x)\mathrm{d}x \implies F(x) = \lim\limits_1^x f$ --- ограничена.
